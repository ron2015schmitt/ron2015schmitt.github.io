...
These videos were created using matlab.  The surfaces themselves were calculated by tracing magnetic field lines, [written in C++](https://github.com/ron2015schmitt/coildes).

...
This project was created for a client.

A demo version is running on netlify.
...
These videos were created using matlab code.  The surfaces themselves were calculated by tracing magnetic field lines, [written in C++](https://github.com/ron2015schmitt/coildes).
